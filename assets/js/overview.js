...
// Specify the URL where your JSON data is hosted (use relative path)
const dataUrl = "https://leedthanh.github.io/api/besthomes.json"; // Updated JSON data URL
...
// Specify the URL for mapping JSON data (use relative path)
const Url = 'https://leedthanh.github.io/api/mapping.json';
...
fetch(Url)
  ...
  .then(jsonData => {
    ...
    const geoJsonUrl = "https://leedthanh.github.io/api/gz_2010_us_040_00_20m.json"; // Updated GeoJSON URL
